...
import random
from model import NetworkTopology, Node
...
class NodeItem(QGraphicsEllipseItem):
    ...
    def start_pulsing(self, color: QColor):
        ...
        if not self.pulse_timer.isActive():
            self.pulse_timer.start(100) # 10 FPS (Optimized)
...
class GraphView(QGraphicsView):
    ...
    def _generate_starfield(self):
        ...
        num_stars = 50 # Reduced for performance
    ...
    def start_packet_animation(self):
        ...
        self.packet_timer.start(50) # 50ms interval (Optimized)
